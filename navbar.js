...
secondNav.insertBefore(searchBox, btnSearch);

btnSearch.addEventListener("click", function () {
  let x = document.querySelector("#searchBox");
...
cartAmount.setAttribute(
  "class",
  "justify-items-center text-center px-2 py3 bg-red-500 rounded-2xl text-white"
);
cartAmount.setAttribute(
  "style",
  "font-family: 'Prompt', sans-serif; font-size: 1.2em;"
);
secondNav.appendChild(cartAmount);
// add event listeners
